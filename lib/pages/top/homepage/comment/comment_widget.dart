  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ProductsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final commentProductsRecord = snapshot.data!;
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Builder(
                                builder: (context) {
                                  if (listViewCommentsRecord.user ==
                                      commentProductsRecord.parentReference) {
                                ...
                                onPressed: () async {
                                  await CommentsRecord.collection.doc().set({
                                    ...createCommentsRecordData(
                                      comment:
                                          _model.userCommentTextController.text,
                                      product: commentProductsRecord.reference,
