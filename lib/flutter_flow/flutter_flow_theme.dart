...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color furugiMainColor = const Color(0xFF333333);
  ...
  late Color alternate = const Color(0xFFDCDCDC);
  late Color primaryText = const Color(0xFF101518);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF0F0F0);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color like = const Color(0xFFEA6F78);
  late Color unlike = const Color(0xFFDCDCDC);
  ...
  late Color info = const Color.fromARGB(255, 0, 0, 0);
}
